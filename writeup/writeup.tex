...
\abstract{
    ...
    Latent Dirichlet Allocation is a assumes that individual words that appear in a document collection
    are drawn form a family of distibutions associated with different topics.
    We automatically learn this distribution from a collection of 20000 physics journal articles:
    % The data set is 
    the fulltext of the \texttt{quant-ph} category of the arXiv.org preprint archive between
    the years 1994 and 2007.
